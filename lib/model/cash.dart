class Model {
  ...
  cashDual({year, month, day}) {
    ...
    .fold<double>(
      0.00,
      (prev, data) => prev + data.component.cash
    );
    debit = dataWhere
    .where((data) => (data.component.cash > 0))
    .fold<double>(
  ...
  cashTotal({year, month, day}) {
    ...
    .fold<double>(
      ...
      (prev, data) {
        ...
        final bank = (data.component.bank != null) ? data.component.bank.fold<double>(
          0.0,
          (prev, bank) => prev + bank.value
        ) : 0.0;
...
class Component {
  ...
  factory Component.fromJson(Map<String, dynamic> json) {
    return Component(
      cash: json['cash'],
      bank: (json['bank'] != null) ? (json['bank'] as List).map((i) => Bank.fromJson(i)).toSet() : null,
    );
  }
}
